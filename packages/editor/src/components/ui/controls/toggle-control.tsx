...
export function ToggleControl({ label, checked, onChange, className }: ToggleControlProps) {
  return (
    <div
      className={cn(
        'group flex h-10 w-full cursor-pointer items-center justify-between rounded-lg border border-border/50 bg-accent/70 px-3 text-sm transition-colors hover:bg-accent',
        className,
      )}
