...
export const CATALOG_ITEMS: AssetInput[] = [
...

  {
    ...
    offset: [0, 0, 0],
    rotation: [0, 0, 0],
    dimensions: [0.5, 1.8, 0.28],
  },

  {
    id: 'air-conditioner-block',
    category: 'appliance',
    tags: ['floor', 'climate', 'outdoor'],
    name: '空调室外机',
    ...
    offset: [0, 0, 0],
    rotation: [0, 0, 0],
    dimensions: [0.9, 0.65, 0.35],
  },

  {
    id: 'flat-screen-tv',
    category: 'appliance',
    tags: ['wall', 'entertainment'],
    name: '平板电视',
...

  {
    ...
    offset: [0, 0, 0],
    rotation: [0, 0, 0],
    dimensions: [2.0, 1.0, 0.1],
  },

  {
    id: 'hedge',
    category: 'outdoor',
    tags: ['floor', 'landscaping'],
    name: '绿篱',
